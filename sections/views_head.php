...
<title>
  <?= $name_website ?> <?php if (isset($_SESSION['project_mitra_agung_malaka']['name_page'])) {
                          if (!empty($_SESSION['project_mitra_agung_malaka']['name_page'])) {
                            echo " - " . $_SESSION['project_mitra_agung_malaka']['name_page'];
                          }
                        } ?>
</title>
